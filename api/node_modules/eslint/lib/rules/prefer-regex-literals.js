...
const { canTokensBeAdjacent } = require("eslint/lib/rules/utils/ast-utils");
const { REGEXPP_LATEST_ECMA_VERSION } = require("eslint/lib/rules/utils/regular-expressions");
