...
const { isValidWithUnicodeFlag } = require("eslint/lib/rules/utils/regular-expressions");
const { parseStringLiteral, parseTemplateToken } = require("eslint/lib/rules/utils/char-source");
