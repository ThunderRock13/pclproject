...
const
    ...
    { getRuleOptionsSchema } = require("eslint/lib/config/flat-config-helpers"),
    { Linter, SourceCodeFixer } = require("eslint/lib/linter"),
    { interpolate, getPlaceholderMatcher } = require("eslint/lib/linter/interpolate"),
    stringify = require("json-stable-stringify-without-jsonify");

const { FlatConfigArray } = require("eslint/lib/config/flat-config-array");
const { defaultConfig } = require("eslint/lib/config/default-config");

const ajv = require("eslint/lib/shared/ajv")({ strictDefaults: true });

const parserSymbol = Symbol.for("eslint.RuleTester.parser");
const { ConfigArraySymbol } = require("@eslint/config-array");
const { isSerializable } = require("eslint/lib/shared/serialization");

const { SourceCode } = require("eslint/lib/languages/js/source-code");
