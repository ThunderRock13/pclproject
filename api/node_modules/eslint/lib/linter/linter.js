...
const
    ...
    { SourceCode } = require("eslint/lib/languages/js/source-code"),
...
const { getRuleFromConfig } = require("eslint/lib/config/flat-config-helpers");
const { FlatConfigArray } = require("eslint/lib/config/flat-config-array");
const { startTime, endTime } = require("eslint/lib/shared/stats");
const { RuleValidator } = require("eslint/lib/config/rule-validator");
const { assertIsRuleSeverity } = require("eslint/lib/config/flat-config-schema");
const { normalizeSeverityToString } = require("eslint/lib/shared/severity");
const jslang = require("eslint/lib/languages/js");
const { activeFlags, inactiveFlags } = require("eslint/lib/shared/flags");
...
const { LATEST_ECMA_VERSION } = require("eslint/conf/ecma-version");
const { VFile } = require("eslint/lib/linter/vfile");
const { ParserService } = require("eslint/lib/services/parser-service");
const { FileContext } = require("eslint/lib/linter/file-context");
const { ProcessorService } = require("eslint/lib/services/processor-service");
...
/** @typedef {import("eslint/lib/shared/types").SuppressedLintMessage} SuppressedLintMessage */
/** @typedef {import("eslint/lib/shared/types").ParserOptions} ParserOptions */
/** @typedef {import("eslint/lib/shared/types").LanguageOptions} LanguageOptions */
/** @typedef {import("eslint/lib/shared/types").Processor} Processor */
/** @typedef {import("eslint/lib/shared/types").Rule} Rule */
/** @typedef {import("eslint/lib/shared/types").Times} Times */
