...
const ajvImport = require("eslint/lib/shared/ajv");
const ajv = ajvImport();
const {
    parseRuleId,
    getRuleFromConfig,
    getRuleOptionsSchema
} = require("eslint/lib/config/flat-config-helpers");
const ruleReplacements = require("eslint/conf/replacements.json");
