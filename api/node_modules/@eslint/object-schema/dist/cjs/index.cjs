...
/** @typedef {import("@eslint/object-schema/dist/cjs/types.ts").ObjectDefinition} ObjectDefinition */
/** @typedef {import("@eslint/object-schema/dist/cjs/types.ts").PropertyDefinition} PropertyDefinition */
