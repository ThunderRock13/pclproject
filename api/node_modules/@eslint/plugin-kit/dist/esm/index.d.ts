...
export type StringConfig = import("@eslint/plugin-kit/dist/esm/types.ts").StringConfig;
export type BooleanConfig = import("@eslint/plugin-kit/dist/esm/types.ts").BooleanConfig;
/**
