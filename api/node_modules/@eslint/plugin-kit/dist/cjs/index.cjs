...
/** @typedef {import("@eslint/plugin-kit/dist/cjs/types.ts").StringConfig} StringConfig */
/** @typedef {import("@eslint/plugin-kit/dist/cjs/types.ts").BooleanConfig} BooleanConfig */
