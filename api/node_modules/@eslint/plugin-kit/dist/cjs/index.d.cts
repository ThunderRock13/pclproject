...
export type StringConfig = import("@eslint/plugin-kit/dist/cjs/types.ts").StringConfig;
export type BooleanConfig = import("@eslint/plugin-kit/dist/cjs/types.ts").BooleanConfig;
/**
